...
-- spell's shield left
local shieldX = CompactArenaFrameMember1.CastingBarFrame:GetHeight() * 2.5
...
for i = 1, 3, 1 do
	...
	_G["TextBorderTop"..i]:SetPoint("TOPLEFT", _G["CompactArenaFrameMember"..i].CastingBarFrame, "TOPLEFT", 4, 12)
	_G["TextBorderTop"..i]:SetPoint("BOTTOMRIGHT", _G["CompactArenaFrameMember"..i].CastingBarFrame, "BOTTOMRIGHT", -4, 4)
...
for i = 1, 3, 1 do
	...
	_G["TextBorderBottom"..i]:SetPoint("TOPLEFT", _G["CompactArenaFrameMember"..i].CastingBarFrame, "TOPLEFT", 4, -4)
	_G["TextBorderBottom"..i]:SetPoint("BOTTOMRIGHT", _G["CompactArenaFrameMember"..i].CastingBarFrame, "BOTTOMRIGHT", -4, -12)
