...
TextBorderTop:SetPoint("TOPLEFT", PlayerCastingBarFrame, "TOPLEFT", 4, 12)
TextBorderTop:SetPoint("BOTTOMRIGHT", PlayerCastingBarFrame, "BOTTOMRIGHT", -4, 4)
...
TextBorderBottom:SetPoint("TOPLEFT", PlayerCastingBarFrame, "TOPLEFT", 4, -4)
TextBorderBottom:SetPoint("BOTTOMRIGHT", PlayerCastingBarFrame, "BOTTOMRIGHT", -4, -12)
