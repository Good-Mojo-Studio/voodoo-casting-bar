...
vcbOptions.Panel4.Box8.CheckButton1.Text:SetWidth(vcbOptions.Panel4.Box8:GetWidth()*0.8)
...
vcbOptions.Panel4.Box8.CheckButton1:HookScript("OnLeave", function(self) VDW.Tooltip_Hide() end)
...
-- status, border
	...
	if VCBsettings.Boss.StatusBar.Interrupt.Show then
		vcbOptions.Panel4.Box8.CheckButton1:SetChecked(true)
		vcbOptions.Panel4.Box8.CheckButton1.Text:SetTextColor(Color.Main:GetRGB())
		vcbOptions.Panel4.Box8.CheckButton1:SetAlpha(1)
	else
		vcbOptions.Panel4.Box8.CheckButton1:SetChecked(false)
		vcbOptions.Panel4.Box8.CheckButton1.Text:SetTextColor(0.35, 0.35, 0.35, 0.8)
	end
-- lock-unlock bar
